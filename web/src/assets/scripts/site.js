...
(function initCreatorFilter() {
  ...
  optionNodes.forEach((node) => {
    ...
    creatorsByKey[key] = {
      ...
      monthCount: Number.parseInt(node.getAttribute("data-month-count") || "0", 10) || 0
    };
  });
  ...
  function applyFilter(activeCreator) {
    ...
    if (activeState) {
      if (activeCreator) {
        ...
        activeState.textContent = `Showing ${activeCreator.name} (${activeCreator.monthCount}) in this month`;
      } else {
